...
function ListBolao() {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(coheza_ui_1.Heading, { children: "Bol\u00E3o" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex justify-between items-center mt-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex gap-5 items-center", children: [(0, jsx_runtime_1.jsx)(coheza_ui_1.TextField, { placeholder: "Buscar Bol\u00E3o", size: "sm" }), (0, jsx_runtime_1.jsx)(coheza_ui_1.Button, { color: "primary", leftIcon: (0, jsx_runtime_1.jsx)(hi_1.HiSearch, {}), size: "sm", children: "Buscar" })] }), (0, jsx_runtime_1.jsx)(coheza_ui_1.Button, { onClick: () => navigate("/create-bolao"), color: "primary", leftIcon: (0, jsx_runtime_1.jsx)(hi_1.HiPlus, {}), size: "xs", children: "Novo Bol\u00E3o" })] }), (0, jsx_runtime_1.jsx)("div", { className: "flex gap-2 flex-col mt-8 ", children: boloes.map((bolao) => ((0, jsx_runtime_1.jsx)(ItemBolao_1.ItemBolao, { bolao: bolao, signIn: signIn, requestSignIn: handleRequestSignIn }))) })] }));
}
